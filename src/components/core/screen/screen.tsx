...
function ScreenWithoutScrolling(props: ScreenProps) {
  ...
  return (
    <KeyboardAvoidingView
      ...
      <View
        style={{
          height: props.enableInsetTop ? insets.top : 0,
...
const Screen = (props: ScreenProps) => {
  return isNonScrolling(props.preset) ? <ScreenWithoutScrolling {...props} /> : <ScreenWithScrolling {...props} />;
};
